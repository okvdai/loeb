global function loebLoadDefault()
{
    ...
    loebAdd(3, Localize("#COMMUNITY_BROWSE_NETWORKS"), OnBrowseNetworkButton_Activate)                      //Browse
    //loebAdd(3, Localize("#INVITE_FRIENDS"), OnInviteFriendsToNetworkButton_Activate)                      //Invite friends (doesn't work on Northstar)
    //STORE (headerIndex 4)
    loebAdd(4, Localize("#MENU_TITLE_STORE_BROWSE"), OnStoreButtonActivate)                                 //Browse
    ...
    //loebAdd(5, Localize("#AUDIO_VIDEO"), AdvanceEventMenuEventHandler(GetMenu("AudioVideoMenu")))         //Audio & Vidoe (doesn't work on Northstar, this is for consoles)
